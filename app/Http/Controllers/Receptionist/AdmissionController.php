...
class AdmissionController extends TenantController
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'correspondence_country_id' => 'required|exists:countries,id',
            'correspondence_state_id' => 'required|exists:states,id',
            'correspondence_city_id' => 'required|exists:cities,id',
