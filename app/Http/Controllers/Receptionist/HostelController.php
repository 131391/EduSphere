...
class HostelController extends TenantController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('receptionist.hostels.index', [
    ...
    private function exportToCsv($query)
    {
        ...
        $callback = function () use ($query) {
            ...
            $query->orderBy('created_at', 'desc')->cursor()->each(function ($hostel) use ($file) {
                fputcsv($file, [
                    $hostel->hostel_name,
    ...
    {
        return redirect()->route('receptionist.hostels.index', ['export' => 'csv']);
    }
}
