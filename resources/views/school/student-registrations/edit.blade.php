...
<div class="p-6" x-data="registrationManagement()">
    ...
    <div x-cloak>
        ...
        @include('school.student-registrations.partials.stepper_header')
                ...
                <div class="p-6 md:p-8 min-h-[480px]">
                    ...
                    <template x-if="currentStep === 1">
                        <div x-transition:enter="transition ease-out duration-200"
                            ...
                            @include('school.student-registrations.partials.step1_reg')
                        </div>
                    </template>
                    ...
                    <template x-if="currentStep === 2">
                        <div x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 translate-y-1"
                             x-transition:enter-end="opacity-100 translate-y-0">
                            @include('school.student-registrations.partials.step2_student')
                        </div>
                    </template>
                    ...
                    <template x-if="currentStep === 3">
                        <div x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 translate-y-1"
                             x-transition:enter-end="opacity-100 translate-y-0">
                            @include('school.student-registrations.partials.step3_parents')
                        </div>
                    </template>
                    ...
                    <div x-show="currentStep === 4" x-cloak
                         ...
                         x-transition:enter-start="opacity-0 translate-y-1"
                         x-transition:enter-end="opacity-100 translate-y-0">
                        @include('school.student-registrations.partials.step4_address')
                    </div>
                    ...
                    <template x-if="currentStep === 5">
                        <div x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 translate-y-1"
                             x-transition:enter-end="opacity-100 translate-y-0">
                            @include('school.student-registrations.partials.step5_media')
                        </div>
                    </template>
...
function registrationManagement() {
    return {
        ...
        formData: {
            admission_status: '{{ $studentRegistration->admission_status instanceof \App\Enums\AdmissionStatus ? $studentRegistration->admission_status->value : $studentRegistration->admission_status }}',
            ...
            student_type: @js($studentRegistration->student_type),
            ...
            religion: @js($studentRegistration->religion),
            category: @js($studentRegistration->category),
            ...
            corresponding_relative: @js($studentRegistration->corresponding_relative),
            ...
            boarding_type: @js($studentRegistration->boarding_type),
            ...
            father_qualification: @js($studentRegistration->father_qualification),
            ...
            mother_qualification: @js($studentRegistration->mother_qualification),
        ...
        async submitForm() {
            ...
            // Address location fields: always read from DOM
