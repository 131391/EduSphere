...
<div class="p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('school.student-registrations.create') }}" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div class="p-4 border-b border-gray-100 dark:border-gray-700">
            <form action="{{ route('school.student-registrations.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('school.student-registrations.show', $registration->id) }}" class="text-blue-500 hover:text-blue-600 transition-colors" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('school.student-registrations.edit', $registration->id) }}" class="text-teal-500 hover:text-teal-600 transition-colors" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('school.student-registrations.destroy', $registration->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this registration?')">
                                    @csrf
                                    @method('DELETE')
