...
@section('content')
    ...
    <div class="flex flex-wrap items-center justify-end gap-4" x-data="{ showImportModal: false }">
        ...
        <a href="{{ route('school.student-registrations.create') }}" class="bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600 flex items-center gap-2 shadow-sm transition">
        ...
        <div x-show="showImportModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <form action="{{ route('school.registrations.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <a href="{{ route('school.registrations.download-template') }}" class="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-800">
    ...
    @php
        ...
        $tableActions = [
            [
                'type' => 'link',
                'url' => fn($row) => route('school.student-registrations.show', $row->id),
                'icon' => 'fas fa-eye',
            ...
            [
                'type' => 'link',
                'url' => fn($row) => route('school.student-registrations.edit', $row->id),
                'icon' => 'fas fa-edit',
            ...
            [
                'type' => 'form',
                'url' => fn($row) => route('school.student-registrations.destroy', $row->id),
                'method' => 'DELETE',
                'icon' => 'fas fa-trash',
