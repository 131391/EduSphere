...
<div class="p-6">
    ...
    @if ($errors->any())
        <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg shadow-sm">
            <div class="flex items-center mb-2">
                ...
                <h3 class="text-base font-bold text-red-800 dark:text-red-300">Registration Failed: Please correct the following errors</h3>
            </div>
    ...
    <form action="{{ route('school.student-registrations.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
