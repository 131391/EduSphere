        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    @include('school.admission.partials._detail_row', ['icon' => 'fa-tint',         'label' => 'Blood Group', 'value' => $studentRegistration->bloodGroup?->name ?? 'N/A'])
                    ...
                    @include('school.admission.partials._detail_row', ['icon' => 'fa-pray',         'label' => 'Religion',    'value' => $studentRegistration->religion?->name ?? 'N/A'])
                    @include('school.admission.partials._detail_row', ['icon' => 'fa-layer-group',  'label' => 'Category',    'value' => $studentRegistration->category?->name ?? 'N/A'])
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    @include('school.admission.partials._detail_row', ['icon' => 'fa-graduation-cap','label' => 'Qualification', 'value' => $studentRegistration->fatherQualification?->name ?? 'N/A'])
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    @include('school.admission.partials._detail_row', ['icon' => 'fa-graduation-cap','label' => 'Qualification', 'value' => $studentRegistration->motherQualification?->name ?? 'N/A'])
                </div>
            </div>
