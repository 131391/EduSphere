{{-- Step 4: Address --}}
{{-- NOTE: This step uses x-show (not x-if) in the parent so the location selector
     DOM is always present and location-cascade.js / Select2 work correctly. --}}
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
            ...
            <input type="text" name="permanent_state_of_domicile" x-model="formData.permanent_state_of_domicile"
        ...
        <div>
            ...
            <input type="text" name="permanent_railway_airport" x-model="formData.permanent_railway_airport"
    ...
    <div x-show="correspondenceExpanded"
        ...
        <div class="md:col-span-2">
            <x-location-selector
                ...
                :countries="$countries"
                :required="false"
                :selectedCountry="old('correspondence_country_id', isset($studentRegistration) ? ($studentRegistration->correspondence_country_id ?? 102) : 102)"
                :selectedState="old('correspondence_state_id', isset($studentRegistration) ? ($studentRegistration->correspondence_state_id ?? '') : '')"
                :selectedCity="old('correspondence_city_id', isset($studentRegistration) ? ($studentRegistration->correspondence_city_id ?? '') : '')"
            />
        </div>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Landmark</label>
            <input type="text" name="correspondence_landmark" x-model="formData.correspondence_landmark"
