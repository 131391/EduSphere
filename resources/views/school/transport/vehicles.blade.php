...
@section('title', 'Vehicle Registry - School Admin')
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[10px] font-medium text-slate-400 dark:text-gray-500 mt-0.5">Ref: {{ $row['vehicle_no'] ?? 'N/A' }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-[10px] font-medium text-slate-400 dark:text-gray-500 mt-0.5" x-text="'Ref: ' + (row.vehicle_no || 'N/A')"></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5">
                        ...
                        <template x-if="errors.registration_no">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.registration_no[0]"></p>
                        </template>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <template x-if="errors.capacity">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.capacity[0]"></p>
                        </template>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <template x-if="errors.engine_no">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.engine_no[0]"></p>
                        </template>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="space-y-1.5">
                        ...
                        <template x-if="errors.vehicle_no">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.vehicle_no[0]"></p>
                        </template>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <template x-if="errors.model_no">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.model_no[0]"></p>
                        </template>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="date" x-model="formData.date_of_purchase" 
                            class="w-full bg-white dark:bg-gray-700 border rounded-xl py-3 px-4 text-sm font-bold text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-teal-500/20 transition-all"
                            :class="errors.date_of_purchase ? 'border-red-500' : 'border-slate-200 dark:border-gray-600'" @change="clearError('date_of_purchase')">
                        <template x-if="errors.date_of_purchase">
                            <p class="text-[10px] text-red-500 font-bold mt-1 ml-1" x-text="errors.date_of_purchase[0]"></p>
                        </template>
                    </div>
                </div>
            </div>
