...
@section('title', 'Edit Student Enquiry')
...
<div class="p-6" x-data="enquiryManagement()">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-0.5">
                ...
                <span class="text-teal-600 font-bold">{{ $studentEnquiry->student_name }}</span>
                &middot;
                <span class="text-gray-400 font-mono text-xs">{{ $studentEnquiry->enquiry_no }}</span>
            </p>
        </div>
    ...
    {{-- Alpine-driven section: cloak the entire block so it paints in one frame --}}
    <div x-cloak>
...
function enquiryManagement() {
    return {
        ...
        formData: {
            ...
            subject_name: @js($studentEnquiry->subject_name),
            student_name: @js($studentEnquiry->student_name),
            gender: '{{ $studentEnquiry->gender instanceof \App\Enums\Gender ? $studentEnquiry->gender->value : $studentEnquiry->gender }}',
            follow_up_date: '{{ $studentEnquiry->follow_up_date?->format('Y-m-d') ?? '' }}',
            form_status: '{{ $studentEnquiry->form_status instanceof \App\Enums\EnquiryStatus ? $studentEnquiry->form_status->value : 1 }}',
            father_name: @js($studentEnquiry->father_name),
            father_contact: @js($studentEnquiry->father_contact),
            father_email: @js($studentEnquiry->father_email),
            father_qualification_id: '{{ $studentEnquiry->father_qualification_id }}',
            father_occupation: @js($studentEnquiry->father_occupation),
            father_annual_income: '{{ $studentEnquiry->father_annual_income }}',
            father_organization: @js($studentEnquiry->father_organization),
            father_office_address: @js($studentEnquiry->father_office_address),
            father_department: @js($studentEnquiry->father_department),
            father_designation: @js($studentEnquiry->father_designation),
            mother_name: @js($studentEnquiry->mother_name),
            mother_contact: @js($studentEnquiry->mother_contact),
            mother_email: @js($studentEnquiry->mother_email),
            mother_qualification_id: '{{ $studentEnquiry->mother_qualification_id }}',
            mother_occupation: @js($studentEnquiry->mother_occupation),
            mother_annual_income: '{{ $studentEnquiry->mother_annual_income }}',
            mother_organization: @js($studentEnquiry->mother_organization),
            mother_office_address: @js($studentEnquiry->mother_office_address),
            mother_department: @js($studentEnquiry->mother_department),
            mother_designation: @js($studentEnquiry->mother_designation),
            contact_no: @js($studentEnquiry->contact_no),
            whatsapp_no: @js($studentEnquiry->whatsapp_no),
            facebook_id: @js($studentEnquiry->facebook_id),
            email_id: @js($studentEnquiry->email_id),
            sms_no: @js($studentEnquiry->sms_no),
            ...
            previous_school_name: @js($studentEnquiry->previous_school_name),
            student_roll_no: @js($studentEnquiry->student_roll_no),
            passing_year: '{{ $studentEnquiry->passing_year }}',
            exam_name: @js($studentEnquiry->exam_name),
            board_university: @js($studentEnquiry->board_university),
