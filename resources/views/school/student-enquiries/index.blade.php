...
<div class="space-y-6" x-data="enquiryManagement()">
    ...
    @php
        ...
        $tableActions = [
            ...
            [
                'type' => 'button',
                'onclick' => function($row) {
                    return "event.stopPropagation(); event.preventDefault(); confirmDelete({$row->id}); return false;";
                },
                'icon' => 'fas fa-trash',
    ...
    <div x-show="showModal && !showDeleteModal" x-cloak 
    ...
    <div x-show="showDeleteModal" 
         ...
         :style="showDeleteModal ? 'display: flex !important; z-index: 99999 !important;' : 'display: none !important;'"
        ...
        <div class="relative mx-auto w-full max-w-md shadow-2xl rounded-xl bg-white dark:bg-gray-800 overflow-hidden"
            ...
            <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4 flex items-center justify-end gap-3">
                ...
                <form :action="`/school/student-enquiries/${deleteEnquiryId}`" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
...
document.addEventListener('alpine:init', () => {
    Alpine.data('enquiryManagement', () => ({
        ...
        confirmDelete(enquiryId) {
            ...
            // Ensure edit modal stays closed
            this.editMode = false;
            this.enquiryId = null;
            ...
            this.$nextTick(() => {
                ...
                if (deleteModal) {
                    ...
                    deleteModal.style.zIndex = '99999';
