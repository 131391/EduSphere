...
document.addEventListener('alpine:init', () => {
    Alpine.data('bloodGroupManagement', () => ({
        ...
        init() {
            window.addEventListener('open-edit-blood-group', (e) => this.openEditModal(e.detail));
            window.addEventListener('open-delete-blood-group', (e) => this.confirmDelete(e.detail));
        },
