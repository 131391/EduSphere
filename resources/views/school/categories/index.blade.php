        ...
        $tableActions = [
            [
                ...
                'onclick' => function($row) {
                    ...
                    return "window.dispatchEvent(new CustomEvent('open-edit-category', { detail: $encoded }))";
                },
                'title' => 'Edit',
            ],
            [
                ...
                'onclick' => function($row) {
                    ...
                    return "window.dispatchEvent(new CustomEvent('open-delete-category', { detail: { id: " . $row->id . ", name: '{$name}' } }))";
                },
                'title' => 'Delete',
            ],
        ];
...
document.addEventListener('alpine:init', () => {
    Alpine.data('categoryManagement', () => ({
        ...
        init() {
            window.addEventListener('open-edit-category', (e) => this.openEditModal(e.detail));
            window.addEventListener('open-delete-category', (e) => this.confirmDelete(e.detail));
        },
