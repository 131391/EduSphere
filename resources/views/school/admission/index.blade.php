...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-end gap-4">
        <a href="{{ route('school.admission.create') }}" class="bg-teal-500 text-white px-4 py-2 rounded hover:bg-teal-600 flex items-center gap-2">
    ...
    @php
        ...
        $tableActions = [
            [
                'type' => 'link',
                'url' => fn($row) => route('school.admission.show', $row->id),
                'icon' => 'fas fa-eye',
            ...
            [
                'type' => 'link',
                'url' => fn($row) => route('school.admission.edit', $row->id),
                'icon' => 'fas fa-edit',
            ...
            [
                'type' => 'form',
                'url' => fn($row) => route('school.admission.destroy', $row->id),
                'method' => 'DELETE',
                'icon' => 'fas fa-trash',
