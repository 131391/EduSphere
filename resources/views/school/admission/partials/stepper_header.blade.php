...
<div class="mb-6">
    <div class="flex items-center justify-between mb-2">
        ...
        <span class="text-xs font-semibold text-teal-600" x-text="stepLabels[currentStep - 1]">{{ $admSteps[0]['label'] }}</span>
    </div>
