...
<div class="mb-5 flex items-center gap-3 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-xl text-sm">
    ...
    <span class="text-gray-500 dark:text-gray-400">These details are carried over from the registration. To change them, update the registration record first.</span>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Date of Birth <span class="text-red-500">*</span></label>
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">DOB Certificate No</label>
        <input type="text" name="dob_certificate_no" x-model="formData.dob_certificate_no" placeholder="Certificate number"
               class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-800 dark:text-white">
    </div>
    ...
    <div>
        ...
        <input type="number" min="0" name="number_of_brothers" x-model="formData.number_of_brothers"
               class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-800 dark:text-white">
    </div>

    <div>
        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">No. of Sisters</label>
        <input type="number" min="0" name="number_of_sisters" x-model="formData.number_of_sisters"
               class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-800 dark:text-white">
    </div>
