...
<div class="mb-6" x-data="{ motherExpanded: false }">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-b-lg border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                    ...
                    <select name="mother_staff_id" x-model="formData.mother_staff_id" class="no-select2 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select name="mother_name_prefix" x-model="formData.mother_name_prefix" @change="clearError('mother_name_prefix')"
                            ...
                            :class="errors.mother_name_prefix ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'">
                    ...
                    <template x-if="errors.mother_name_prefix">
                        <p class="text-red-500 text-xs mt-1" x-text="errors.mother_name_prefix[0]"></p>
                    </template>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="mother_first_name" x-model="formData.mother_first_name" @input="clearError('mother_first_name')" placeholder="Enter First Name"
                    ...
                    <template x-if="errors.mother_first_name">
                        <p class="text-red-500 text-xs mt-1" x-text="errors.mother_first_name[0]"></p>
                    </template>
                </div>
            </div>
        </div>
        ...
        {{-- Collapsible Details --}}
        <div x-show="motherExpanded" x-collapse>
            <div class="px-6 pb-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="mother_last_name" x-model="formData.mother_last_name" @input="clearError('mother_last_name')" placeholder="Enter Last Name"
                               class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white"
                               :class="errors.mother_last_name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'">
                        <template x-if="errors.mother_last_name">
                            <p class="text-red-500 text-xs mt-1" x-text="errors.mother_last_name[0]"></p>
                        </template>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="mother_occupation" x-model="formData.mother_occupation" placeholder="Enter Occupation"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="mother_pan" x-model="formData.mother_pan" placeholder="Enter PAN No"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white">
                    </div>
                </div>
            </div>
