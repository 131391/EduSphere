...
<div class="mb-5 flex items-center gap-3 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-xl text-sm">
    ...
    <span class="text-gray-500 dark:text-gray-400">Parent details are carried over from the registration. To change them, update the registration record first.</span>
</div>
    ...
    <div class="bg-blue-50/50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30 overflow-hidden">
        ...
        <div class="p-5">
            ...
            <div x-show="fatherExpanded"
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">PAN No</label>
                    <input type="text" name="father_pan" x-model="formData.father_pan" placeholder="PAN number"
                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-800 dark:text-white">
                </div>
            </div>
        </div>
    ...
    <div class="bg-pink-50/50 dark:bg-pink-900/10 rounded-xl border border-pink-100 dark:border-pink-900/30 overflow-hidden">
        ...
        <div class="p-5">
            ...
            <div x-show="motherExpanded"
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">PAN No</label>
                    <input type="text" name="mother_pan" x-model="formData.mother_pan" placeholder="PAN number"
                           class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-800 dark:text-white">
                </div>
            </div>
        </div>
