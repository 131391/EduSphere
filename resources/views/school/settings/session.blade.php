            ...
            <form action="{{ route('school.settings.session.update') }}" method="POST">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-bold text-gray-900">Select Active Year</h2>
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="p-4 border-2 rounded-xl transition-all"
                                        ...
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            @if($year->is_current)
                                                <span class="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-bold uppercase tracking-wide rounded-lg">
                                                    Active
                                                </span>
                                            @endif
                                        </div>
                                        <p class="text-sm font-bold text-gray-900">{{ $year->name }}</p>
                ...
                {{-- Warning notice --}}
                <div class="mt-4 bg-amber-50 border border-amber-100 rounded-2xl p-4 flex items-start gap-3">
                    <div class="w-8 h-8 rounded-lg bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <i class="fas fa-exclamation-triangle text-amber-500 text-sm"></i>
                    </div>
                    <div>
                        <p class="text-sm font-semibold text-amber-900 mb-0.5">Heads up before switching</p>
        ...
        <div class="space-y-5">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-gray-900">Current Session</h2>
