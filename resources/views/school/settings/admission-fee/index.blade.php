...
@section('content')
    <div x-data="Object.assign(ajaxDataTable({
    ...
    }), admissionFeeManager())" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <x-stat-card label="Average Fee Rate" :value="'₹' . $stats['average_admission_fee']" icon="fas fa-calculator" color="indigo" alpine-text="'₹' + stats.average_admission_fee" />
        ...
        <!-- Header Section -->
        <x-page-header title="Admission Fee Settings" description="Configure one-time enrollment charges applicable to new admissions across different academic classes." icon="fas fa-door-open">
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex-1 flex flex-col md:flex-row md:items-center gap-4">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Configuration Matrix</h2>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-50/50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Admission Rate</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700 transition-opacity duration-150" x-cloak :class="loading ? 'opacity-50' : 'opacity-100'">
                        ...
                        <x-table.empty-state :colspan="4" icon="fas fa-door-open" message="No admission fees match your search." />
                    </tbody>
                </table>
            </div>
        ...
        <!-- Add/Edit Modal -->
        <x-modal name="admission-fee-modal" alpineTitle="editMode ? 'Edit Admission Rate' : 'Define New Admission Rate'" maxWidth="md">
            <form @submit.prevent="submitForm()" method="POST" class="p-1">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Amount -->
                    <div class="space-y-2">
                        <label class="modal-label-premium">Admission Amount <span class="text-red-600 font-bold">*</span></label>
                        <div class="relative group">
                ...
                <x-slot name="footer">
                    <button type="button" @click="$dispatch('close-modal', 'admission-fee-modal')" class="btn-premium-cancel px-10">Discard</button>
                    <button type="submit" :disabled="submitting" class="btn-premium-primary min-w-[160px] !from-indigo-600 !to-blue-600 shadow-indigo-200">
                ...
                return {
                    ...
                    async submitForm() {
                        ...
                        const url = this.editMode 
                            ...
                            : '{{ route('school.settings.admission-fee.store') }}';
                    ...
                    async confirmDelete(row) {
                        ...
                        window.dispatchEvent(new CustomEvent('open-confirm-modal', {
                            detail: {
                                title: 'Delete Admission Rate',
                                message: `Are you sure you want to delete the admission fee for "${row.class_name}"? This action cannot be undone.`,
                                callback: async () => {
                                    try {
