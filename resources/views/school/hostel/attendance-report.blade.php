...
<div class="space-y-6">
    ...
    <x-page-header title="Attendance Report" description="View hostel attendance history by date and hostel" icon="fas fa-history">
        ...
        <a href="{{ route('school.hostel.attendance.report', array_merge(request()->all(), ['export' => 'excel'])) }}"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div class="p-6">
            <form method="GET" action="{{ route('school.hostel.attendance.report') }}">
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    <a href="{{ route('school.hostel.attendance.report') }}" class="px-3 py-1 bg-rose-50 text-rose-600 text-[10px] font-black rounded-lg border border-rose-100 hover:bg-rose-100 transition-all uppercase tracking-widest">
