                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button @click="quickAction(`/school/hostel/floors/{{ $row['id'] }}`, 'Delete Floor', 'DELETE')" title="Delete"
            ...
            <form @submit.prevent="save" id="floorForm" class="p-1" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <template x-if="errors.floor_name && errors.floor_name[0]">
        ...
        <script>
            function floorForm() {
                return {
                    ...
                    async save() {
                        const errs = {};
                        if (!this.formData.hostel_id) errs.hostel_id = ['The hostel id field is required.'];
                        if (!this.formData.floor_name || !this.formData.floor_name.trim()) errs.floor_name = ['The floor name field is required.'];
                        if (Object.keys(errs).length) { this.errors = errs; return; }

                        this.submitting = true;
                        this.errors = {};
                        const url = this.editMode
                            ? `{{ route('school.hostel.floors.index') }}/${this.floorId}`
                            : `{{ route('school.hostel.floors.store') }}`;
