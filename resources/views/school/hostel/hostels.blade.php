...
@section('content')
    <div x-data="Object.assign(ajaxDataTable({
            fetchUrl: '{{ route('school.hostel.hostels.fetch') }}',
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <x-stat-card label="Residents" :value="$stats['total_residents']" icon="fas fa-user-graduate" color="rose"
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button @click="quickAction(`/school/hostel/hostels/{{ $row['id'] }}`, 'Delete Hostel', 'DELETE')" title="Delete"
                ...
                return {
                    ...
                    async save() {
                        ...
                        const url = this.editMode
                            ? `{{ route('school.hostel.hostels.index') }}/${this.hostelId}`
                            : `{{ route('school.hostel.hostels.store') }}`;
