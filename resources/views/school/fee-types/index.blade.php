                    ...
                    <tr>
                        <td colspan="2" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-lg text-gray-500">No fee types found</p>
                                <p class="text-sm text-gray-400 mt-1">Click "Create Fee Type" to add your first fee type</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
