...
@section('content')
<div class="space-y-6">
    <a href="{{ route('student.fees.index') }}" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
