...
@section('content')
<div class="max-w-2xl">
    <a href="{{ route('parent.profile.show') }}" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors mb-4">
        <i class="fas fa-arrow-left"></i> Back to Profile
    </a>

    <form method="POST" action="{{ route('parent.profile.password.update') }}"
