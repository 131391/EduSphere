        ...
        <aside
            ...
            <div class="p-4 border-b border-blue-800 relative group">
                    ...
                    <div class="bg-white rounded-full flex items-center justify-center transition-all duration-300 logo-container"
                        ...
                        @if(isset($school) && $school->logo)
                            <img src="{{ asset('storage/' . $school->logo) }}" alt="{{ $school->name }}"
                                ...
                                :style="sidebarCollapsed ? 'width: 2.5rem; height: 2.5rem;' : 'width: 4rem; height: 4rem;'">
                        @else
                            <i class="fas fa-chalkboard-teacher text-blue-900 logo-img"
                ...
                <div x-show="!sidebarCollapsed" x-transition:enter="transition ease-out duration-200"
                    ...
                    <p class="text-[10px] uppercase font-bold tracking-widest text-blue-300 text-center mt-1">Teacher Portal</p>
                </div>
                    ...
                    @foreach($navItems as $item)
                        ...
                        <li>
                            <a href="{{ route($item['route']) }}"
                                class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs(str_replace('.index', '.*', $item['route'])) ? 'bg-blue-800 text-white' : 'text-blue-200 hover:bg-blue-800' }}"
                                :class="{ 'justify-center': sidebarCollapsed }">
                                <i class="fas {{ $item['icon'] }} w-5 text-center" :class="{ 'mr-3': !sidebarCollapsed }"></i>
                                <span x-show="!sidebarCollapsed" class="sidebar-text">{{ $item['label'] }}</span>
                            </a>
                        </li>
                        @endif
                    @endforeach
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4" x-data="headerActions()">
                        ...
                        <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                            ...
                            <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
                                ...
                                style="display: none;">
                                <!-- Profile link disabled pending route implementation -->
                                <!--
                                <a href="#"
