                ...
                <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4" x-data="{
                        ...
                        <button @click="toggleDarkMode()"
                            ...
                            <i class="text-xl far fa-moon" x-show="false" style="display:inline-block" id="student-dark-icon"></i>
                        </button>
                        <script>if(localStorage.getItem('darkMode')==='true'||(!('darkMode'in localStorage)&&window.matchMedia('(prefers-color-scheme: dark)').matches)){var _d=document.getElementById('student-dark-icon');if(_d){_d.className='text-xl fas fa-sun';}}</script>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-1 sm:space-x-2 focus:outline-none">
                                ...
                                <span class="text-gray-700 dark:text-gray-200 font-medium hidden sm:inline text-sm">{{ Auth::user()->name ?? 'Student' }}</span>
