        ...
        <aside class="w-64 bg-blue-900 text-white flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto py-4 sidebar-scroll" 
                ...
                <ul class="space-y-1 px-2">
                    ...
                    <!-- Examination -->
                    <li>
                        <button @click="openMenus.examination = !openMenus.examination" class="w-full flex items-center justify-between px-4 py-2 rounded-lg text-blue-200 hover:bg-blue-800">
                            <div class="flex items-center">
                                <i class="fas fa-calendar-alt w-5 mr-3"></i>
                                <span>Examination</span>
                            </div>
                            <i class="fas fa-chevron-right text-xs transition-transform" :class="{ 'rotate-90': openMenus.examination }"></i>
                        </button>
                        <ul x-show="openMenus.examination" 
                            x-cloak
                            class="ml-4 mt-1 space-y-1"
                            style="display: none;">
                            <!-- Examination sub-items can be added here -->
                        </ul>
                    </li>

                    <!-- Setting -->
                    <li>
                        <button @click.stop="openMenus.setting = !openMenus.setting" class="w-full flex items-center justify-between px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.*') ? 'bg-blue-800 text-white' : 'text-blue-200 hover:bg-blue-800' }}">
                            <div class="flex items-center">
                                <i class="fas fa-cog w-5 mr-3"></i>
                                <span>Setting</span>
                            </div>
                            <i class="fas fa-chevron-right text-xs transition-transform" :class="{ 'rotate-90': openMenus.setting }"></i>
                        </button>
                        <ul x-show="openMenus.setting" 
                            x-cloak
                            class="ml-4 mt-1 space-y-1"
                            :style="openMenus.setting ? '' : 'display: none;'">
                            <li>
                                <a href="{{ route('admin.settings.logo') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.logo') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Logo Update</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.basic-info') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.basic-info') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Basic Information</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.registration-fee') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.registration-fee') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Registration Fee</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.admission-fee') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.admission-fee') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Admission Fee</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.receipt-note') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.receipt-note') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Receipt Note</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.set-session') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.set-session') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Set Session</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.late-return-fine') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.late-return-fine') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Late Return Library Book Fine</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.settings.admission-fee-applicable') }}" 
                                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.settings.admission-fee-applicable') ? 'text-white font-semibold' : 'text-blue-200 hover:bg-blue-800' }}">
                                    <i class="fas fa-minus w-3 mr-3"></i>
                                    <span>Admission Fee Applicable</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Admission News -->
                    <li>
                        <a href="{{ route('admin.admission-news') }}" 
                           class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.admission-news') ? 'bg-blue-800 text-white' : 'text-blue-200 hover:bg-blue-800' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.support') }}" 
                           class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.support') ? 'bg-blue-800 text-white' : 'text-blue-200 hover:bg-blue-800' }}">
