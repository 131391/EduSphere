...
<body class="bg-gray-100 dark:bg-gray-900 transition-colors">
    ...
    <script>
        (function() {
            // Initialize confirmModal API that works with Alpine.js modals
                ...
                window.confirmModal = {
                    ...
                    show(modalId, callback, options = {}) {
                        ...
                        if (!modal) {
                            ...
                            if (callback && confirm(options.message || 'Are you sure?')) {
                                callback();
                            }
                            return false;
                        }
                        ...
                        // The modal component listens for this event
                    ...
                    hide(modalId) {
                        const modal = document.getElementById(modalId);
                        if (modal) {
                            // Find Alpine.js component and trigger close
