                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4" x-data="{
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-cloak @click.outside="open = false"
                                ...
                                <a href="{{ route('parent.profile.show') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                                    <i class="fas fa-user-circle mr-3 text-gray-400 dark:text-gray-500"></i>Profile
                                </a>
                                <a href="{{ route('parent.profile.password') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                                    <i class="fas fa-key mr-3 text-gray-400 dark:text-gray-500"></i>Change Password
                                </a>
