                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                $colorClass = match($visitor->status) {
                                    VisitorStatus::Scheduled => 'bg-blue-100 text-blue-800',
                                    VisitorStatus::CheckedIn => 'bg-yellow-100 text-yellow-800',
                                    VisitorStatus::Completed => 'bg-green-100 text-green-800',
                                    VisitorStatus::Cancelled => 'bg-red-100 text-red-800',
