    ...
    <div x-show="showModal" x-cloak 
        ...
        <div class="relative mx-auto w-full max-w-4xl shadow-2xl rounded-xl bg-white dark:bg-gray-800 overflow-hidden"
            ...
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 py-4 flex items-center justify-between">
                <h3 class="text-xl font-bold text-white" x-text="editMode ? 'Edit Bus Stop' : 'Add New Bus Stop'"></h3>
            ...
            <form :action="editMode ? '{{ url('receptionist/bus-stops') }}/' + busStopId : '{{ route('receptionist.bus-stops.store') }}'" 
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Route *</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Bus Stop No *</label>
                            <input type="text" name="bus_stop_no" x-model="formData.bus_stop_no" value="{{ old('bus_stop_no') }}"
                    ...
                    {{-- Row 2: Bus Stop Name --}}
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Bus Stop Name *</label>
                        <input type="text" name="bus_stop_name" x-model="formData.bus_stop_name" value="{{ old('bus_stop_name') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" step="0.00000001" name="latitude" x-model="formData.latitude" value="{{ old('latitude') }}"
                        ...
                        <div>
                            ...
                            <input type="number" step="0.00000001" name="longitude" x-model="formData.longitude" value="{{ old('longitude') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="distance_from_institute" x-model="formData.distance_from_institute" value="{{ old('distance_from_institute') }}"
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="charge_per_month" x-model="formData.charge_per_month" value="{{ old('charge_per_month') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="area_pin_code" x-model="formData.area_pin_code" value="{{ old('area_pin_code') }}"
