                    ...
                    async save() {
                        ...
                        try {
                            ...
                            if (response.ok) {
                                ...
                                throw new Error(window.resolveApiMessage(result, 'Failed to save bus stop'));
                            }
                        } catch (e) {
                            window.Toast?.fire({ icon: 'error', title: window.resolveApiMessage(e.response?.data || { message: e.message }, 'Failed to save bus stop') });
                        } finally {
