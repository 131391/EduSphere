            ...
            <div>
                ...
                <div class="relative">
                    <input type="date" 
                           ...
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-teal-500 focus:ring-teal-500 shadow-sm pl-10 pr-10 py-2.5 h-[42px] appearance-none cursor-pointer">
