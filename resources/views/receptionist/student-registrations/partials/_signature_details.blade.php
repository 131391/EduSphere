...
<div class="mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-b-lg border border-gray-200 dark:border-gray-700">
        {{-- Hidden fields to store signature paths from enquiry --}}
        <input type="hidden" name="enquiry_father_signature" id="enquiry_father_signature" value="">
        <input type="hidden" name="enquiry_mother_signature" id="enquiry_mother_signature" value="">
        <input type="hidden" name="enquiry_student_signature" id="enquiry_student_signature" value="">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 bg-gray-200 dark:bg-gray-600 rounded-lg mb-2 flex items-center justify-center overflow-hidden relative">
                        @if(isset($studentRegistration) && $studentRegistration->father_signature)
                            <img id="father-signature-preview" src="{{ asset('storage/' . $studentRegistration->father_signature) }}" alt="Father Signature" class="w-full h-full object-cover">
                        @else
                            <img id="father-signature-preview" src="#" alt="Father Signature" class="hidden w-full h-full object-cover">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 bg-gray-200 dark:bg-gray-600 rounded-lg mb-2 flex items-center justify-center overflow-hidden relative">
                        @if(isset($studentRegistration) && $studentRegistration->mother_signature)
                            <img id="mother-signature-preview" src="{{ asset('storage/' . $studentRegistration->mother_signature) }}" alt="Mother Signature" class="w-full h-full object-cover">
                        @else
                            <img id="mother-signature-preview" src="#" alt="Mother Signature" class="hidden w-full h-full object-cover">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-32 h-32 bg-gray-200 dark:bg-gray-600 rounded-lg mb-2 flex items-center justify-center overflow-hidden relative">
                        @if(isset($studentRegistration) && $studentRegistration->student_signature)
                            <img id="student-signature-preview" src="{{ asset('storage/' . $studentRegistration->student_signature) }}" alt="Student Signature" class="w-full h-full object-cover">
                        @else
                            <img id="student-signature-preview" src="#" alt="Student Signature" class="hidden w-full h-full object-cover">
