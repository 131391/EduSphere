        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-id-badge',     'label' => 'Aadhaar No',  'value' => $studentRegistration->aadhar_no ?? 'N/A'])
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-user',          'label' => 'Name',          'value' => trim($studentRegistration->father_name_prefix . ' ' . $studentRegistration->father_first_name . ' ' . $studentRegistration->father_last_name)])
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-user',          'label' => 'Name',          'value' => trim($studentRegistration->mother_name_prefix . ' ' . $studentRegistration->mother_first_name . ' ' . $studentRegistration->mother_last_name)])
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-5 space-y-4">
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-file-alt',       'label' => 'Registration No',  'value' => $studentRegistration->registration_no])
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-calendar-check', 'label' => 'Registration Date','value' => $studentRegistration->registration_date?->format('d M Y') ?? 'N/A'])
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-graduation-cap', 'label' => 'Applied Class',    'value' => $studentRegistration->class->name ?? 'N/A'])
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-calendar-alt',   'label' => 'Academic Year',    'value' => $studentRegistration->academicYear->name ?? 'N/A'])
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-rupee-sign',     'label' => 'Registration Fee', 'value' => '₹' . number_format($studentRegistration->registration_fee, 2)])
                    @include('receptionist.admission.partials._detail_row', ['icon' => 'fa-info-circle',    'label' => 'Status',           'value' => $studentRegistration->admission_status->label()])
                </div>
            </div>
