...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-3">
            <a href="{{ route('receptionist.student-registrations.edit', $studentRegistration->id) }}" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
