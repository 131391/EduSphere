...
@section('content')
    <div class="p-6">
        ...
        <form action="{{ route('receptionist.student-registrations.update', $studentRegistration->id) }}" method="POST"
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <select name="admission_status" required
                    class="w-full md:w-1/3 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:text-white">
