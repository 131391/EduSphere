            ...
            <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div class="flex-shrink-0">
                    @if($visitor->visitor_photo)
                        <img src="{{ asset('storage/' . $visitor->visitor_photo) }}" alt="Visitor Photo"
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div>
                            ...
                            <span class="font-semibold">Type:</span> {{ $visitor->visitor_type?->label() ?? 'N/A' }}
                        </div>
                        <div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900">{{ $visitor->visit_purpose?->label() ?? 'N/A' }}
                            </p>
                        </div>
                    </div>
                    @if($visitor->source)
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900">{{ $visitor->meeting_with?->label() ?? 'N/A' }}</p>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">
                                    {{ $visitor->meeting_scheduled->format('d M, Y h:i A') }}</p>
                            </div>
                        </div>
                    @endif
                    @if($visitor->check_out)
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">{{ $visitor->check_out->format('d M, Y h:i A') }}
                                </p>
                            </div>
                        </div>
                    @endif
                        ...
                        @if($visitor->id_proof)
                            <div class="text-center">
                                ...
                                <div class="border-2 border-gray-300 rounded-lg p-3 bg-gray-50 inline-block">
                                    ...
                                    @else
                                        <img src="{{ asset('storage/' . $visitor->id_proof) }}" alt="ID Proof"
                                            class="w-48 h-48 object-cover rounded">
                                    @endif
                                </div>
                            </div>
