...
@section('content')
<div class="max-w-2xl">
    <a href="{{ route('teacher.profile.show') }}" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors mb-4">
    ...
    <form method="POST" action="{{ route('teacher.profile.password.update') }}"
        ...
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700">
            ...
            <p class="text-xs text-gray-500 mt-1">Choose a strong password — at least 8 characters with mixed case and numbers.</p>
        </div>
        ...
        <div class="p-6 space-y-4">
            <div>
                ...
                <input type="password" name="current_password" required autocomplete="current-password"
                       class="w-full h-10 px-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
